...
namespace DALPublic
{
    public class DALMethod
    {
        ...
        #region 连接字符串
        //public string strConnect = @"Data Source=192.168.191.1;Initial Catalog=集团客运管理系统;User ID=as;Password=123";

        public string strConnect = @"Data Source=DESKTOP-6A5V189;Initial Catalog=集团客运管理系统;User ID=sa;Password=123";
